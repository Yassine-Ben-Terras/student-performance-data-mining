...
1. Clonez ce repository :
   ```bash
   git clone [https://github.com/votre-nom-utilisateur/student-performance-data-mining.git](https://github.com/votre-nom-utilisateur/student-performance-data-mining.git)
